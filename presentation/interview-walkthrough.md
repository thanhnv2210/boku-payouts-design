...
# Eight Design Gaps — Addressed

| # | Gap | Resolution |
|---|---|---|
| 1 | **Merchant auth undefined** | OAuth2 client credentials — `client_id`/`client_secret` → short-lived JWT with `merchant_id` claim scoped to every payout |
